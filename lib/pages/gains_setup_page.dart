...
class GainsSetupPage extends StatefulWidget {
  const GainsSetupPage({Key? key}) : super(key: key);

  @override
  State<GainsSetupPage> createState() => _GainsSetupPageState();
}

class _GainsSetupPageState extends State<GainsSetupPage> {
  @override
